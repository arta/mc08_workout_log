class WorkoutsController < ApplicationController
  ...
  #   genertated by: =form_for @workout .. on /workouts/new view that rendered
  #   /workouts/_form partial with @workout.new_record?
  def create
  ...
  #   generated by: =form_for @workout .. on /workouts/edit view that rendered
  #   /workouts/_form partial with @workout.persistent?
  #   router extracts :id value from the request into params[:id]=value pair
  def update
